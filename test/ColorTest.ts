...
describe('Color Tests', function () {
  it('test color creation', function () {
    ...
    color.setRed(64);
    validateColor(color, 0x400000, '#400000', '#400000', 64, 0, 0, 0.0, 1.0, 0.13);
    color.setRed(128 / 255.0);
    validateColor(color, 0x800000, '#800000', '#800000', 128, 0, 0, 0.0, 1.0, 0.25);
    color.setRed('C0');
    validateColor(color, 0xc00000, '#C00000', '#C00000', 192, 0, 0, 0.0, 1.0, 0.38);
    color.setRed(0xff);
    validateColor(color, 0xff0000, '#FF0000', '#F00', 255, 0, 0, 0.0, 1.0, 0.5);
    expect(color.isOpaque()).to.be.true;

    color.setGreen(64);
    validateColor(color, 0xff4000, '#FF4000', '#FF4000', 255, 64, 0, 15.1, 1.0, 0.5);
    color.setGreen(128 / 255.0);
    validateColor(color, 0xff8000, '#FF8000', '#FF8000', 255, 128, 0, 30.1, 1.0, 0.5);
    color.setGreen('c0');
    validateColor(color, 0xffc000, '#FFC000', '#FFC000', 255, 192, 0, 45.2, 1.0, 0.5);
    color.setGreen(0xff);
    validateColor(color, 0xffff00, '#FFFF00', '#FF0', 255, 255, 0, 60.0, 1.0, 0.5);
    expect(color.isOpaque()).to.be.true;

    color.setBlue(64);
    validateColor(color, 0xffff40, '#FFFF40', '#FFFF40', 255, 255, 64, 60.0, 1.0, 0.63);
    color.setBlue(128 / 255.0);
    validateColor(color, 0xffff80, '#FFFF80', '#FFFF80', 255, 255, 128, 60.0, 1.0, 0.75);
    color.setBlue('C0');
    validateColor(color, 0xffffc0, '#FFFFC0', '#FFFFC0', 255, 255, 192, 60.0, 1.0, 0.88);
    color.setBlue(0xff);
    validateColor(color, 0xffffff, '#FFFFFF', '#FFF', 255, 255, 255, 0.0, 0.0, 1.0);
    expect(color.isOpaque()).to.be.true;
  ...
  it('test color hex constants', function () {
    ...
    validateColor(color, 10824234, '#A52A2A', '#A52A2A', 165, 42, 42, 0.0, 0.59, 0.41);
    color = new Color();
    color.setColor(ColorConstants.CYAN);
    validateColor(color, 65535, '#00FFFF', '#0FF', 0, 255, 255, 180.0, 1.0, 0.5);
    color = new Color();
    color.setColor(ColorConstants.DKGRAY);
    validateColor(color, 4473924, '#444444', '#444', 68, 68, 68, 0.0, 0.0, 0.27);
    color = new Color();
    color.setColor(ColorConstants.GRAY);
    validateColor(color, 8947848, '#888888', '#888', 136, 136, 136, 0.0, 0.0, 0.53);
    color = new Color();
    ...
    validateColor(color, 13421772, '#CCCCCC', '#CCC', 204, 204, 204, 0.0, 0.0, 0.8);
    color = new Color();
    color.setColor(ColorConstants.MAGENTA);
    validateColor(color, 16711935, '#FF00FF', '#F0F', 255, 0, 255, 300.0, 1.0, 0.5);
    color = new Color();
    color.setColor(ColorConstants.ORANGE);
    validateColor(color, 16753920, '#FFA500', '#FFA500', 255, 165, 0, 39.0, 1.0, 0.5);
    color = new Color();
    color.setColor(ColorConstants.PINK);
    validateColor(color, 16761035, '#FFC0CB', '#FFC0CB', 255, 192, 203, 350.0, 1.0, 0.88);
    color = new Color();
    color.setColor(ColorConstants.PURPLE);
    validateColor(color, 8388736, '#800080', '#800080', 128, 0, 128, 300.0, 1.0, 0.25);
    color = new Color();
    ...
    validateColor(color, 15631086, '#EE82EE', '#EE82EE', 238, 130, 238, 300.0, 0.76, 0.72);
    color = new Color();
    color.setColor(ColorConstants.WHITE);
    validateColor(color, 16777215, '#FFFFFF', '#FFF', 255, 255, 255, 0.0, 0.0, 1.0);
    color = new Color();
    color.setColor(ColorConstants.YELLOW);
    validateColor(color, 16776960, '#FFFF00', '#FF0', 255, 255, 0, 60.0, 1.0, 0.5);
