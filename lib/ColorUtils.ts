...
export class ColorUtils {
     ...
     */
    public static toColorShorthand(red: string, green: string,
        blue: string): string {
    ...
    public static toColorShorthandWithAlpha(red: string, green: string,
        blue: string, alpha: string): string {
   ...
   */
    ...
    */
    ...
    public static shorthandHex(color: string): string {
        ...
        if (color.length > 5) {
            ...
            for (; startIndex < color.length; startIndex += 2) {
                let shorthand = ColorUtils.shorthandHexSingle(
    ...
    public static shorthandHexSingle(color: string): string {
        ColorUtils.validateHexSingle(color);
        if (color.length > 1
            && color.charAt(0).toUpperCase() == color.charAt(1)
                .toUpperCase()) {
